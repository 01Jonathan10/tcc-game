...
from .models import Player, Quest, QuestInstance, Skill, TaskReview, Score, Item
...
class PlayerSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['name', 'pk', 'level', 'job', 'gender', 'trait_skin', 'trait_hair', 'trait_eyes',
                  'trait_skin_color', 'trait_hair_color', 'trait_eyes_color', 'energy', 'skills', 'stats', 'xp', 'gold',
                  'diamonds']
